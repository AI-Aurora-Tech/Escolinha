...
import { Plus, Search, Edit, Trash2, User as UserIcon, FileText, Filter, DollarSign, CheckCircle, XCircle, AlertCircle, FileWarning, Send, Link as LinkIcon, Download, X, Save, Phone, Mail, MapPin, Calendar, Camera } from 'lucide-react';
                        ...
                        >
                            ...
                            <div className="space-y-2 text-sm text-gray-600">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="truncate">{student.guardian.name} (Resp.)</span>
                                </div>
                                <div className="flex items-center gap-2">
              ...
              <div className="fixed inset-0 z-40 bg-gray-900/50 backdrop-blur-sm flex justify-end">
                  <div className="w-full max-w-2xl bg-white h-full shadow-2xl overflow-y-auto animate-in slide-in-from-right duration-300">
                        ...
                        <div className="px-6 border-b border-gray-100 flex gap-6">
                            <button onClick={() => setActiveTab('INFO')} className={`py-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'INFO' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
                                Dados do Aluno
                            </button>
                            <button onClick={() => setActiveTab('FINANCE')} className={`py-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'FINANCE' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
                                Financeiro
                            </button>
                             <button onClick={() => setActiveTab('ATTENDANCE')} className={`py-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'ATTENDANCE' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
                                Frequência
                            </button>
                        </div>
